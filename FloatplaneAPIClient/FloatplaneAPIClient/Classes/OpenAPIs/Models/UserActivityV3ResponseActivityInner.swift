//
// UserActivityV3ResponseActivityInner.swift
//
...
public struct UserActivityV3ResponseActivityInner: Content, Hashable {
    ...
    public init(time: Date, comment: String, postTitle: String, postId: String, creatorTitle: String, creatorUrl: String) {
        self.time = time
