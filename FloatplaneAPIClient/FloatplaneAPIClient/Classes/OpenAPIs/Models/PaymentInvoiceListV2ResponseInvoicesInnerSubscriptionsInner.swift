//
// PaymentInvoiceListV2ResponseInvoicesInnerSubscriptionsInner.swift
//
...
public struct PaymentInvoiceListV2ResponseInvoicesInnerSubscriptionsInner: Content, Hashable {
    ...
    public var plan: PaymentInvoiceListV2ResponseInvoicesInnerSubscriptionsInnerPlan

    public init(id: Int, subscription: Double, periodStart: Date?, periodEnd: Date?, value: Double, amountSubtotal: Double, amountTotal: Double, amountTax: Double, plan: PaymentInvoiceListV2ResponseInvoicesInnerSubscriptionsInnerPlan) {
        self.id = id
