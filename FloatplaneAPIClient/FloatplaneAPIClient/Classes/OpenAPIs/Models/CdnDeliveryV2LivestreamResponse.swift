//
// CdnDeliveryV2LivestreamResponse.swift
//
...
public struct CdnDeliveryV2LivestreamResponse: Content, Hashable {
    ...
    public var resource: CdnDeliveryV2LivestreamResponseResource

    public init(cdn: String, strategy: Strategy, resource: CdnDeliveryV2LivestreamResponseResource) {
        self.cdn = cdn
