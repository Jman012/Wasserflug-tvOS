//
// CdnDeliveryV2VodLivestreamResponse.swift
//
...
public struct CdnDeliveryV2VodLivestreamResponse: Content, Hashable {
    ...
    public init(cdn: String, strategy: Strategy, resource: CdnDeliveryV2ResourceModel) {
        self.cdn = cdn
